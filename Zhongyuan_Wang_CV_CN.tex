...
\begin{itemize}
\item 构建银行欺诈告警调查的 production-style Agentic Engineering workflow，覆盖 Agent Loop、Context/Planner、Guardrails、case\_store 状态机、Evidence/Report Agents、SFT/RLVR/RLHF、评估与 runtime/MLOps 可靠性。
