...
\begin{itemize}
\item 构建 criteria-driven multi-agent autopilots，覆盖论文与专利生产: LLM APIs、function calling/tool use、文献/gap 扫描、实验核验、TMLR gates、prior-art search、专利 drafting、counsel handoff 和 audit log。
...
\cvsection{技术技能}
\textbf{Agent / ML}: LLM APIs, function calling/tool use, multi-agent orchestration, GitHub automation, PyTorch, PyG, GNNs, autoencoders, fraud-ring detection\\
