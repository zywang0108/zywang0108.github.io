...
\cvitem{ML / Graph}{PyTorch, PyTorch Geometric (PyG), GNNs, autoencoders, anomaly detection, link prediction, fraud-ring detection, LLM-based investigation}
\cvitem{Data \& MLOps}{Spark / PySpark, Kafka, ClickHouse, Redis, Parquet, Docker, Kubernetes, ArgoCD, CI/CD, FastAPI / gRPC, MLflow}
\cvitem{Cloud}{AWS (S3 / EC2 / ECR), Grafana, Prometheus, Loki}
